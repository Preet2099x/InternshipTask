    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Interscopian Limited</h3>
            <p className="mb-4 text-gray-400">
              Providing exceptional digital solutions and services that help businesses transform and thrive in today's competitive landscape.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition duration-300">Projects</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Business Avenue, Suite 100<br />New Delhi, India 831005</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@company.com" className="text-gray-400 hover:text-white transition duration-300">preetsingh3101a@gmail.com</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Interscopian Limited. All rights reserved.
            </div>
